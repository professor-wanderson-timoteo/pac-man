...
class BoardCanvas extends Canvas {
  ...
  drawGhostsPen() {
    ...
    this.ctx.strokeRect(
      11 * Board.tileSize - Board.halfLine,
      13 * Board.tileSize - Board.halfLine,
      6 * Board.tileSize + Board.lineWidth,
      3 * Board.tileSize + Board.lineWidth
    );
    this.ctx.strokeRect(
      13 * Board.tileSize - Board.halfLine,
      12.5 * Board.tileSize,
      2 * Board.tileSize + Board.lineWidth,
      Board.tileSize / 2 - Board.halfLine
    );
    this.ctx.clearRect(
      13 * Board.tileSize,
      12.5 * Board.tileSize - Board.halfLine,
      2 * Board.tileSize,
      Board.tileSize / 2 + Board.halfLine
    );
    ...
    this.ctx.strokeRect(
      13 * Board.tileSize + Board.halfLine,
      12.5 * Board.tileSize + Board.lineWidth,
      2 * Board.tileSize - Board.lineWidth,
      Board.halfLine
    );
    this.ctx.restore();
  ...
  drawTShape(x, y, left, right, type) {
    ...
    this.ctx.translate(
      data.x * width * Board.tileSize,
      data.y * Board.tileSize
    );
  ...
  drawOuterSmallCorner(x, y, type) {
    let radius = this.corners[type],
      ...
      pos = {
        x:
          (x + data.x.cell) * Board.tileSize +
          radius.x * Board.smallRadius +
          data.x.line * Board.halfLine,
        y:
          (y + data.y.cell) * Board.tileSize +
          radius.y * Board.smallRadius +
          data.y.line * Board.halfLine,
      };
